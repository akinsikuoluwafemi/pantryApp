...
import { SearchIcon as SearchI, CheffCap } from '../assets/Logos/svg/icons';
		...
		<Header>
			<div className="container header-wrapper">
				...
				<ul>
					...
					<IconButton onClick={() => alert('yes')} style={{outline: 'none', marginRight: '1rem'}} aria-label="search" color="inherit">
						<SearchIcon />
					</IconButton>
