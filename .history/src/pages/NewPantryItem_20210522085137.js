    ...
    return (
		...
		>
			...
			<form onSubmit={handleSubmit}>
				...
				<Form.Item label="">
					<Select style={{ border: `${category.length !== 0 ? '' : ''1px solid red''}` , borderRadius: '10px'}} className="ant-style" placeholder="Enter a Category" onChange={handleCategory}>
						{options.map((cat) => (
					...
					<small style={{color: 'red'}}>Pls input category</small>
				</Form.Item>
