...
import { Form, Select, Input, DatePicker, InputNumber, Space, But } from 'antd';
    ...
    return (
		...
		>
			...
			<form>
				...
				<Form.Item label="">
					<Select className="ant-style" placeholder="Enter a Category" onChange={handleChange}>
				...
				<Button block style={{ background: '#FDC039'  }}>
					Add New Item
				</Button>
			</form>
		</NewPantrySection>
