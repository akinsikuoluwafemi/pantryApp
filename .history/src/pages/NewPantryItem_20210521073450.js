...
import { Form, Select, Input, InputNumber, Date Space } from 'antd';
			...
			<form onSubmit={handleSubmit}>
				...
				<Form.Item label="">
					<Select className="ant-style" placeholder="Enter a Category" onChange={handleCategory}>
						<Select.Option value="meat-and-poultry" name="meat-and-poultry" >meat and poultry</Select.Option>
						<Select.Option value="fruit-and-vegetables" name="fruit-and-vegetables" >fruit and vegetables</Select.Option>
						<Select.Option value="dairy" name="dairy">dairy</Select.Option>
						<Select.Option value="canned-goods" name="canned-goods">canned-goods</Select.Option>
						<Select.Option value="baking-items" name="baking-items">baking-items</Select.Option>
						<Select.Option value="liquid-items" name="liquid-items">liquid-items</Select.Option>
					</Select>
				</Form.Item>
