...
export default function NewPantryItem() {
	...
	const [showErrorText, setShowErrowText] = useState(false);
		...
		>
			...
			<form onSubmit={handleSubmit}>
				...
				<Form.Item label="">
					<Select
						style={{
							border: `${category.length === 0 ? '' : '1px solid red'}`,
							borderRadius: `${category.length === 0 ? '' : '10px'}`,
						}}
						className="ant-style"
					...
					{category.length === 0 ? <small style={{ color: 'red' }}>Pls input category</small> : ''}
				</Form.Item>
