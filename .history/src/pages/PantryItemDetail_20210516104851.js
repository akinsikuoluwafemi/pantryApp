...
import { PantryDetailValuesWrapper } from '../styles/PantryDetailStyles';
					...
					return (
						<>
							...
							<PantryDetailValuesWrapper>
								<span className="text-center" style={{ color: '#BCBCBC', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
									<Chip
										size="small"
